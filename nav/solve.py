...
def point_to_point(boundary, waypoints, stat_obstacles, display=False):
    # Parameters
    granularity = 7.0
    ...
    # Quantized Path
    quantized_path = quantize_graph_path(graph_path, origin_loc,
                                         granularity, quantization_distance)
    if display:
