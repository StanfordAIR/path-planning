...
max_obstacle_count = 5 # Each environment will have 1 - N obstacles, with equal probability
obstacle_radius_mean = 5 # Mean of obstacle radius
obstacle_radius_variance = 2 # Variance of obstacle radius
